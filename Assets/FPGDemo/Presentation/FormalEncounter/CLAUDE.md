...
- `VFX/PF_FPG_CoverTransition.prefab` 是 `FpgCoverTransitionEffectView` 的 authored wrapper；玩家 prefab 上的 `FpgCoverTraversalPresenter` 只能播放视觉/相机过渡，不能提交 gameplay traversal。
