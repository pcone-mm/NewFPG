...
- 验证以 Unity 编译/Console、`FpgRoomArtSceneContractTests.cs`、`FpgRoomArtSceneLoaderPlayModeTests.cs`、`BuildSettingsTests.cs` 和 `FormalFirstAuthoringContractTests.cs` 为准。
