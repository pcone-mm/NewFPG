...
- 验证以 Unity 编译/Console、`GameBootstrapConfigTests.cs`、`FormalFirstAuthoringContractTests.cs`、`FpgFormalCameraPoseUtilityTests.cs`、`FpgFormalPlayerCameraFeedbackTests.cs`、`FpgSkillPresentationRuntimeTests.cs`、`FpgFormalEnemyRootMotionAssetTests.cs` 与对应 Formal EditMode 合同为准。
