# Monster_1006018 extracted study data

This directory contains 28 exact, decompressed records from `main`, `shadow`
copied from the local game client's SSRC chunks. The installed client was read
only; no client file was modified.

- `Raw/main` preserves the original main resource names and wrappers.
- `Raw/shadow` preserves the original shadow resource names and wrappers.
